...
public class Room
{
   ...
   */
  public Room(int startX, int startY, int width, int height, boolean isHallway, Player player,
              UpdateManager updateManager)
  {
    ...
    boundingBox =
        new Rectangle2D.Float(startX * Settings.tileSize, startY * Settings.tileSize, width * Settings.tileSize,
